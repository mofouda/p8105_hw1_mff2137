...
maximum, and number of NA's respectively for the body mass variable: species: `r summary(penguins$species)`, island: `r summary(penguins$island)`, body mass: `r summary(penguins$body_mass_g)` , and sex: `r summary(penguins$sex)`.
